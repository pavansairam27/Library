...
private:
// creating integer to keep track of how many books are their
  int numberOfBooks = 0;

  //setting the max number of books

  static const int MAX = 100;

//creating the array and setting it with the max

  string booksOfArray[MAX];

  // finding the index of the array that you want to delete.
